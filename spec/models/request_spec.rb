  ...
  describe '#as_json' do
    ...
    context 'all stages are pending or notified' do
      ...
      it 'has active_stage pointing to the first stage' do
        expect(subject.as_json).to include('active_stage_number' => 1, 'total_stages' => 3)
    ...
    context 'all stages are completed' do
      ...
      it 'has active_stage pointing to the first stage' do
        expect(subject.as_json).to include('active_stage_number' => 3, 'total_stages' => 3)
    ...
    context 'some stage is active' do
      ...
      it 'has active_stage pointing to the first stage' do
        expect(subject.as_json).to include('active_stage_number' => 2, 'total_stages' => 3)
